      ...
      <div className="cardsParent">
        <div className="firstCard">
          <form>
            <div className="billDiv">
              <span>Bill</span>
              <InputFirst setBill={setBill} bill={bill} />
            </div>
            ...
            <div className="numberOfPeopleParent">
              ...
              <span
                className="redAlertZero"
                style={{ display: people >= 1 ? "none" : "block" }}
              >
                Can't be zero
              </span>
              <PeoppleInput people={people} setPeople={setPeople} />
            </div>
          </form>
        </div>
        {/* --------------------- */}
        <div className="secondCard">
          ...
          <button
            ...
            style={{
              backgroundColor:
                (buttonTotal, customTotal) === 0 ? "#0D686D" : "",
            }}
          >
            RESET
          </button>
...
const Buttonsgroup = (props) => {
  return buttons.map((button, index) => (
    <button
      ...
      style={{
        backgroundColor: props.focus === index ? "hsl(172, 67%, 45%)" : "",
      }}
      onClick={(e) => {
...
let PeoppleInput = (props) => {
  function peopleNumber(f) {
    props.setPeople(Math.trunc(f.target.value));
  }
  return (
    <input
      type="number"
  ...
  return (
    <div>
      ...
      <span
        ...
        style={{
          fontSize:
            props.customTotal >= 10000
              ? "25px"
              : "" || props.customTotal > 111111111
              ? "20px"
              : "",
        }}
      >
